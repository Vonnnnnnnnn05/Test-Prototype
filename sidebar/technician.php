...
<div class="flex min-h-screen">
    <aside id="sidebar" class="sidebar open lg:transform-none w-56 min-h-screen bg-primary text-gray-300 flex flex-col fixed z-50 lg:relative lg:z-auto lg:min-h-screen">
        <div class="p-4 border-b border-green-700 flex items-center justify-between">
            <div><h2 class="text-white text-sm font-semibold">Technician Panel</h2><p class="text-xs text-gray-300">ICT System</p></div>
            <button id="hamburger" class="hamburger lg:hidden flex flex-col gap-1.5 p-2 rounded-lg bg-primaryHover hover:bg-green-900 transition z-[60]" onclick="toggleSidebar()"><span class="hamburger-line w-6 h-0.5 bg-white block"></span><span class="hamburger-line w-6 h-0.5 bg-white block"></span><span class="hamburger-line w-6 h-0.5 bg-white block"></span></button>
        </div>
        <nav class="flex-1 py-3"><ul class="space-y-1 text-sm">
            ...
            <li><a href="my-tickets.php" class="flex items-center gap-3 px-5 py-2 <?php echo $currentPage=='my-tickets.php'?'bg-green-900/40 border-l-4 border-accent text-white':'hover:bg-primaryHover hover:text-white';?> transition"><i data-feather="clipboard" class="w-4 h-4"></i>My Tickets</a></li>
            <li><a href="assigned-tasks.php" class="flex items-center gap-3 px-5 py-2 <?php echo $currentPage=='assigned-tasks.php'?'bg-green-900/40 border-l-4 border-accent text-white':'hover:bg-primaryHover hover:text-white';?> transition"><i data-feather="check-square" class="w-4 h-4"></i>Assigned Tasks</a></li>
        ...
        <div class="p-4 border-t border-green-700"><button onclick="logout()" class="flex items-center justify-center gap-2 bg-danger text-white py-2 rounded-md hover:bg-red-700 transition text-sm w-full"><i data-feather="log-out" class="w-4 h-4"></i>Logout</button></div>
    </aside>
