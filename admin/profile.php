    ...
    <main class="ml-0 p-6 w-full flex-1">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 max-w-2xl">
            <div class="flex items-center gap-6 mb-6">
                <div class="w-24 h-24 bg-primary rounded-full flex items-center justify-center text-white text-3xl font-bold">A</div>
                <div>
                    <h2 class="text-xl font-semibold">Admin User</h2>
                    <p class="text-gray-500">System Administrator</p>
                    <p class="text-sm text-gray-400">admin@school.edu</p>
                </div>
            </div>
            <form>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" value="Admin" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Last Name</label>
                        <input type="text" value="User" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none">
                    </div>
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                    <input type="email" value="admin@school.edu" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none">
                </div>
                <div class="mb-4">
