...
<head>
    ...
    <title>Activity Logs - OJT Panel</title>
</head>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm"><span class="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-medium">Assisting</span></td>
                        <td class="px-6 py-4 text-sm">Started assisting Jane Doe with server issue</td>
                    </tr>
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 text-sm text-gray-500">2026-04-25 09:15</td>
                        <td class="px-6 py-4 text-sm font-medium">#T003</td>
                        <td class="px-6 py-4 text-sm"><span class="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-medium">Completed</span></td>
                        <td class="px-6 py-4 text-sm">Completed assistance for printer issue</td>
                    </tr>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm">Assigned to assist Bob Wilson with computer issue</td>
                    </tr>
                </tbody>
            </table>
        </div>
